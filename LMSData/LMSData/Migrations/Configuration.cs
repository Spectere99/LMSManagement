    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LIMSData.LMSDataDBContext>
    {
        ...
        protected override void Seed(LIMSData.LMSDataDBContext context)
        {
            ...
            if (!context.Lookups.Any())
            {
                ...
                defaultLookups.Add(new Lookup() { Archived = false, Id = 3, LookupTypeId = 2, Created = DateTime.Now,  
                                        CreatedBy = "INSTALL", LastModified = DateTime.Now, LastModifiedBy = "INSTALL", LookupValue = "Claims"});
                ...
                defaultLookups.Add(new Lookup() { Archived = false, Id = 11, LookupTypeId = 3, Created = DateTime.Now,
                ...
                defaultLookups.Add(new Lookup() { Archived = false, Id = 14, LookupTypeId = 4, Created = DateTime.Now,
