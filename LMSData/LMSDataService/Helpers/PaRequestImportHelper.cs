...
{
    public class PaRequestImportHelper : IFileImportHelper
    {
        ...
        public List<string> Import(HttpFileCollection files, string saveFolder, string user, string hostIP)
        {
            ...
            foreach (string file in files)
            {
                ...
                if (postedFile != null)
                {
                    ...
                    if (successRows == 0) // We will archive this batch so it won't show up as a selection
                    {
                        fileUploadLogRecord.Archived = true;
                    }
                }
